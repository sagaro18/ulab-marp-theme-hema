...
<img src="images/architecture.png" height="400px">
</div>
...
Each waypoint $p_\ell$ is a concrete image coordinate which turns topology into a verbalized point-trace.
...
<div class="h_center v_center">
<img src="images/fig1.png" height="360px">
</div>
...
- But the topological-reasoning numbers should be read carefully as training and eval data share the same synthetic pipeline.
